...
const Footer = () => {
  ...
  return (
    <footer className=" text-white py-8 mt-auto bg-neutral-900/60 backdrop-filter backdrop-blur  shadow shadow-neutral-950  ">
      <div className="container mx-auto max-w-screen-xl px-4 2xl:px-0 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-gray-300 mt-2">
            ...
            your ultimate destination for all things anime. We are dedicated to
            providing you with the latest and hottest anime episodes, manga, and
            other content.
          </p>
          <p className="text-gray-400 mt-4">
            &copy; {year} RedCloudHub. All rights reserved.
          </p>
        </div>
